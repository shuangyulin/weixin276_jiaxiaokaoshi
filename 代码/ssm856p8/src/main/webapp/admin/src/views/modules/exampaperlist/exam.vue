<template>
  <div class="container">
    <div class="top-content">
      ...
      <div class="right-content">
        <el-button type="danger" round @click="leaveTap">结束理论考试</el-button>
      </div>
    </div>
    ...
    <div class="detail-content" v-if="isEndFlag">
      ...
      <div class="item-content" style="color:#888888">
        <el-button @click="finishTap" type="primary">结束理论考试</el-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    leaveTap() {
      this.$confirm(`确定离开理论考试?未答题目按0分计算`, "提示", {
    ...
    submitTap() {
      ...
      let record = {
        userid: this.user.id,
	username: this.user.xueyuanzhanghao,
