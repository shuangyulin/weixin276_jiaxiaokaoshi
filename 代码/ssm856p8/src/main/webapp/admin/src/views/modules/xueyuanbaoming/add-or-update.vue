<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="驾照类型" prop="jiazhaoleixing">
          <el-input v-model="ruleForm.jiazhaoleixing" 
              placeholder="驾照类型" clearable  :readonly="ro.jiazhaoleixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学车费用" prop="xuechefeiyong">
          <el-input v-model="ruleForm.xuechefeiyong" 
              placeholder="学车费用" clearable  :readonly="ro.xuechefeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学车费用" prop="xuechefeiyong">
              <el-input v-model="ruleForm.xuechefeiyong" 
                placeholder="学车费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiazhaoleixing = true;
          ...
          if(o=='xuechefeiyong'){
            this.ruleForm.xuechefeiyong = obj[o];
	    this.ro.xuechefeiyong = true;
            continue;
          }
          if(o=='baomingshijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xueyuanbaoming/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xueyuanbaomingCrossAddOrUpdateFlag = false;
						 this.parent.search();
